...
class DayClosureController extends ApiController
{
    public function index(Request $request)
    {
        ...
        $items = $paginator->getCollection()->map(function (DayClosure $closure) {
            return [
                ...
                'total_cash_payments' => (float) $closure->total_cash_payments,
                'total_network_payments' => (float) $closure->total_network_payments,
                'total_purchases_payments' => (float) $closure->total_purchases_payments,
    ...
    public function store(Request $request)
    {
        ...
        $summary = [
            ...
            'total_cash_payments' => (float) $entries->where('payment_type', 'cash')->sum('sales'),
            'total_network_payments' => (float) $entries->where('payment_type', 'network')->sum('sales'),
            'total_purchases_payments' => (float) $entries->where('payment_type', 'purchases')->sum('sales'),
        ...
        $closure = DB::transaction(function () use ($data, $summary, $request) {
            $created = DayClosure::create([
                ...
                'total_cash_payments' => $summary['total_cash_payments'],
                'total_network_payments' => $summary['total_network_payments'],
                'total_purchases_payments' => $summary['total_purchases_payments'],
    ...
    public function show(DayClosure $dayClosure)
    {
        ...
        return $this->success([
            ...
            'summary' => [
                ...
                'total_cash_payments' => (float) $dayClosure->total_cash_payments,
                'total_network_payments' => (float) $dayClosure->total_network_payments,
                'total_purchases_payments' => (float) $dayClosure->total_purchases_payments,
